/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 2fc197fdc0313af924ee84a87a7e72be)
// Runtime types generated with workerd@1.20251001.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CACHE: KVNamespace;
		SESSIONS: KVNamespace;
		JWT_SECRET: "LmPkEAze5jbwndNh/INYLrUMu51113Mz3N8QejiVnuE=";
		NEXTJS_ENV: string;
		IMAGES: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
